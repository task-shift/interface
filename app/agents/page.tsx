              ...
              <div className="h-[400px] overflow-y-auto pr-2 space-y-4 scrollbar-thin scrollbar-thumb-[#1a1a1a] scrollbar-track-transparent hover:scrollbar-thumb-[#262626]">
                {displayedAgents.map((agent) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-[#4d4d4d] mb-2">{agent.platform}</p>
                    ...
                    <div className="flex items-center justify-between text-sm text-[#4d4d4d] mt-4">
                      <div className="flex flex-col">
                        <span className="text-white text-base mb-1">{agent.messages}</span>
                        <span>Total messages</span>
                      </div>
                      <div className="flex flex-col items-end">
                        <span className="text-white text-base mb-1">Last active</span>
